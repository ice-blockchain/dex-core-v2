...
export function preprocBuildContractsLocal(opts: {
    ...
    autocleanup?: boolean,
    defaultBCLPFee?: bigint,
    defaultBCProtocolFee?: bigint,
    defaultProtocolFeePCT?: bigint,
    ...
    preprocBuildContracts({
        ...
        data: {
            ...
            defaultBCLPFee: opts.defaultBCLPFee ?? undefined,
            defaultBCProtocolFee: opts.defaultBCProtocolFee ?? undefined,
            defaultProtocolFeePCT: opts.defaultProtocolFeePCT ?? undefined,
...
export const configParams = {
    ...
    defaultProtocolFeePCT: resolveBigInt,
